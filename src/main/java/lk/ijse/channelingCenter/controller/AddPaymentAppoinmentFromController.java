...
public class AddPaymentAppoinmentFromController {
    ...
    public void btnBackOnAction(ActionEvent actionEvent) throws IOException {
        ...
        medicinePlaceOrderPane.getChildren().add(FXMLLoader.load(this.getClass().getResource("/View/AddPaymentFrom.fxml")));
